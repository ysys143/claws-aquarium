...
1. **4계층 성숙도 아키텍처**: 12개 구현체는 보안/기억/세션 관리 복잡도에 따라 Tier 1(엔터프라이즈) ~ Tier 4(실험)로 분류된다. **Tier 1 삼총사(IronClaw, ZeroClaw, OpenClaw)의 기술 선택이 완전히 다르면서도 각각 우수하다**는 발견이 가장 중요. 신규 편입된 **OpenFang(Agent OS)**은 S등급으로 Tier 1을 압도하는 독립 카테고리를 형성한다.
...
| 항목 | OpenClaw | Nanobot | NanoClaw | IronClaw | ZeroClaw | PicoClaw | TinyClaw | OpenJarvis | OpenFang | NemoClaw |
|------|----------|---------|----------|----------|----------|----------|----------|-----------|----------|----------|
| **언어** | TypeScript | Python | TypeScript | Rust | Rust | Go | TypeScript | Python+Rust | Rust | JS/TS/Py/Shell |
| **규모** | 430K+ LOC | 4K LOC | 20K LOC | 15K LOC | 12K LOC | 10K LOC | 5K LOC | ~50K+ LOC | 137K LOC | 25,650 LOC |
| **저자** | 범용 (open) | 개인 | Anthropic | Anthropic | 개인 | 개인 | 개인 | Stanford | 개인 | NVIDIA |
| **라이선스** | 상업/오픈 | MIT | 상업 | 상업 | MIT | MIT | MIT | 상업 | MIT | 상업 |
| **주요 용도** | 범용 에이전트 | 개인 에이전트 | 사내 배포 | 엔터프라이즈 | 개인 고급 | 모바일/엣지 | 팀 협업 | 다중채널 | Agent OS | GPU 샌드박스 |

### 2.2 런타임 특성

| 항목 | OpenClaw | Nanobot | NanoClaw | IronClaw | ZeroClaw | PicoClaw | TinyClaw | OpenJarvis | OpenFang | NemoClaw |
|------|----------|---------|----------|----------|----------|----------|----------|-----------|----------|----------|
| **배포 방식** | 호스팅됨 | 자체 배포 | K8s/Docker | 자체 배포 | 자체 배포 | 자체 배포 | 자체 배포 | 자체 배포 | 자체 배포 | OpenClaw 플러그인 |
| **컨테이너** | Docker | [X] | Docker | Docker | [X] | [X] | [X] | [X] | [X] | NIM 컨테이너 |
| **WASM 샌드박스** | [X] | [X] | [X] | [O] (이중) | [O] | [X] | [X] | [X] | [O] (이중 미터링) | [X] |
| **에이전트 수** | 1+ | 1 (spawn) | 팀 (Teams) | 1 | 1 | 1 | N (분산) | 1+ (9종) | 1 (멀티모델) | 1 (정책 제어) |
| **프로세스 격리** | [X] | [X] | [O] | [O] | [O] | [X] | [X] | [X] | [O] | [O] (Landlock) |

### 2.3 세션/컨텍스트 관리

| 항목 | OpenClaw | Nanobot | NanoClaw | IronClaw | ZeroClaw | PicoClaw | TinyClaw | OpenJarvis | OpenFang | NemoClaw |
|------|----------|---------|----------|----------|----------|----------|----------|-----------|----------|----------|
| **세션 키 전략** | agent:<id>:<type>:<uuid> | channel:chat_id | group_folder | (user, channel, thread) | session_id (DB) | agent:id:ch:kind:peer | agent_dir | session_id + channel_ids | 3-layer context window | OpenClaw 위임 |
| **멀티에이전트** | [O] | [O] | [O] | [O] | [X] | [X] | [O] | [O] | [O] (멀티모델) | DELTA |
| **컴팩션** | 동기 | 비동기 LLM | SDK 자동 | 선택 가능 | 동기 | 비동기 | SDK 자동 | 비동기 | 12-section 빌더 | OpenClaw 위임 |
| **장기기억** | [O] (LanceDB) | [O] (.md) | DELTA | [O] (벡터) | [O] (SQLite) | [O] (.md) | DELTA | [O] (SQLite+5종) | [O] (KG+SQLite) | [X] |
| **Cross-Channel** | [X] | [X] | [X] | [X] | [X] | [X] | [X] | [O] | [O] (40채널) | [X] |

### 2.4 기억 아키텍처

| 항목 | OpenClaw | Nanobot | NanoClaw | IronClaw | ZeroClaw | PicoClaw | TinyClaw | OpenJarvis | OpenFang | NemoClaw |
|------|----------|---------|----------|----------|----------|----------|----------|-----------|----------|----------|
| **저장 백엔드** | SQLite + LanceDB | 파일 (.md) | 파일 (아카이브) | PostgreSQL + libSQL | SQLite + FTS5 | 파일 (.md) | 파일 (아카이브) | SQLite/FAISS/ColBERT/BM25/RRF | SQLite BLOB (11테이블) + KG | OpenClaw 호스트 의존 |
| **임베딩** | [O] (6개) | [X] | [X] | [O] (4개) | [O] (3개) | [X] | [X] | [O] (FAISS+ColBERTv2) | [O] (중요도 스코어링) | [X] |
| **하이브리드 검색** | [O] (4단계) | [X] | [X] | [O] (RRF) | [O] (linear) | [X] | [X] | [O] (BM25+Hybrid RRF) | [O] (KG+SQLite) | [X] |
| **수명주기** | Atomic | 없음 | 없음 | 30일 | 12h | 없음 | 없음 | 24h | Importance scoring | 없음 |
| **Soul Snapshot** | [X] | [X] | [X] | [X] | [O] | [X] | [X] | [X] | [O] (영속 스냅샷) | [X] |

### 2.5 보안/권한

| 항목 | OpenClaw | Nanobot | NanoClaw | IronClaw | ZeroClaw | PicoClaw | TinyClaw | OpenJarvis | OpenFang | NemoClaw |
|------|----------|---------|----------|----------|----------|----------|----------|-----------|----------|----------|
| **암호화 볼트** | [X] | [X] | [X] | [O] (AES) | [O] (ChaCha) | [X] | [X] | [X] | [O] (18 capability types) | [X] |
| **HITL** | [O] | [X] | [X] | [O] | [O] | [X] | DELTA | [X] | [O] | [O] (operator 승인) |
| **Prompt Injection** | DELTA | [X] | [X] | [O] (4중) | [O] (6패턴) | [X] | [X] | [O] (Scanner+Taint) | [O] (Taint tracking) | DELTA |
| **Taint Tracking** | [X] | [X] | [X] | [X] | [X] | [X] | [X] | [O] | [O] (16-layer) | [X] |
| **비용 제한** | DELTA | [X] | [X] | DELTA | [O] ($5) | [X] | [X] | [X] | [X] | [X] |

### 2.6 도구/액션 시스템

| 항목 | OpenClaw | Nanobot | NanoClaw | IronClaw | ZeroClaw | PicoClaw | TinyClaw | OpenJarvis | OpenFang | NemoClaw |
|------|----------|---------|----------|----------|----------|----------|----------|-----------|----------|----------|
| **도구 유형** | TS Plugin | Python ABC | SKILL.md | Rust Trait | Rust Trait | Go Iface | CLI | Python Class | WASM sandbox | OpenClaw 플러그인 명령 |
| **빌트인 도구 수** | 50+ | 10+ | 15+ | 20+ | 16+ | 15+ | 5+ | 24+ | 60 | 10 정책 프리셋 |
| **MCP 지원** | [O] | [O] | [O] | [O] | [O] | [O] | [O] | [O] (어댑터) | [O] (양방향) | [X] (OpenClaw 위임) |
| **브라우저** | [O] (50+) | [X] | DELTA | DELTA | [O] (16) | [X] | [X] | [O] (axtree) | [O] (CDP 네이티브, 50+) | [X] |
| **SSRF 방지** | [O] | [X] | [X] | [O] | [O] | [X] | [X] | DELTA | [O] | [O] (network deny-by-default) |

### 2.7 메신저 인터페이스

| 항목 | OpenClaw | Nanobot | NanoClaw | IronClaw | ZeroClaw | PicoClaw | TinyClaw | OpenJarvis | OpenFang | NemoClaw |
|------|----------|---------|----------|----------|----------|----------|----------|-----------|----------|----------|
| **지원 범위** | Discord+Slack | Telegram | Discord | Discord | Telegram | Telegram | 팀 | 24채널+ | 40채널 어댑터 | Telegram 브릿지 |
| **채널 정책** | [O] | [O] | [O] | [O] | DELTA | DELTA | DELTA | [O] | [O] (채널별 모델 오버라이드) | DELTA |
| **다중채널 세션** | [X] | [X] | [X] | [X] | [X] | [X] | [X] | [O] | [O] | [X] |
...
**구현체**: IronClaw, ZeroClaw, OpenClaw, OpenJarvis
...
| 측면 | IronClaw | ZeroClaw | OpenClaw | OpenJarvis |
|------|----------|----------|----------|-----------|
| **철학** | Zero-Exposure (컨테이너 자격증명 미노출) | 정책 기반 세밀 제어 | 실용적 다층 방어 | Trace-driven 학습 루프 |
| **기억** | pgvector RRF | SQLite+vec 선형 fusion | LanceDB 4단계 파이프라인 | SQLite/FAISS/ColBERT/BM25/RRF 5중 |
| **비용** | 추적만 (무한) | $5/일 하드 한도 | 추적만 (무한) | 속도 제한 |
| **WASM** | 이중 (도구+실행) | 단일 (실행용) | 없음 | 없음 |
| **특수 기능** | Zero-Exposure 프록시 | E-Stop + Soul Snapshot | 50+ 브라우저 기능 | Taint Tracking + 다중채널 SessionIdentity |
...
1. **MCP가 사실상의 표준**: 12개 중 10개가 MCP 지원 (NemoClaw와 TinyClaw만 미지원). 직접 도구 개발보다 MCP 서버 통합이 대세. OpenFang의 MCP 양방향 + A2A 프로토콜이 차세대 패턴.
...
생성된 아이디어의 "실제성"을 LLM 판별기로 검증. 기존 12개에 없는 패턴.
...
| 기능 | OpenClaw | Nanobot | NanoClaw | IronClaw | ZeroClaw | PicoClaw | TinyClaw | OpenJarvis | OpenFang | NemoClaw | 점수 |
|------|:--------:|:-------:|:--------:|:--------:|:--------:|:--------:|:--------:|:----------:|:--------:|:--------:|:----:|
| 24/7 구동 | [O] | DELTA | DELTA | [O] | [O] | DELTA | [X] | DELTA | [O] | [O] | 5/10 |
| 메신저 통합 | [O] | [O] | [O] | [O] | [O] | [O] | [O] | [O] | [O] | DELTA | 9/10 |
| 자율성 제어 | [O] | [X] | [X] | [O] | [O] | [X] | DELTA | [X] | [O] | [O] | 5/10 |
| 커넥터 다양성 | TOP | OK | BASIC | GOOD | GOOD | OK | BASIC | GOOD | TOP | BASIC | - |
| 보안 등급 | 2 | 3 | 2 | 1 | 1 | 3 | 4 | 1 | S | 1.5 | Avg 1.95 |
| 기억 시스템 | 1 | 3 | 3 | 1 | 1 | 3 | 4 | 1 | S | 4 | Avg 2.2 |
| 세션 관리 | 1 | 2 | 1 | 1 | 2 | 2 | 2 | 1 | 1 | 2 | Avg 1.5 |
| 운영 단순도 | DELTA | [O] | [O] | DELTA | DELTA | [O] | [O] | DELTA | DELTA | DELTA | 4/10 |
| **종합 평가** | **[VERY_GOOD]** | **[GOOD]** | **[GOOD]** | **[VERY_GOOD]** | **[VERY_GOOD]** | **[GOOD]** | **[FAIR]** | **[VERY_GOOD]** | **[EXCELLENT]** | **[GOOD+]** | |
...
12개 오픈소스 에이전트 런타임을 비교한 결과, **24시간 상주 메신저 에이전트의 요구사항은 기존 시스템과 근본적으로 다르며, 이를 충족하기 위해서는 Tier 1 수준의 보안, 기억, 세션 관리가 필수**임이 확인되었다.

신규 분석된 3개 프레임워크는 각기 다른 니치를 선점한다:
...
**최종 완성**: 2026-03-17
**통합 분석 대상**: 12개 에이전트 런타임 + 2개 연구 도구 + 5개 기존 보고서
