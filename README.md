...
Claw 에이전트 런타임의 7가지 주요 구현체를 종합 분석하는 프로젝트입니다. 각 프레임워크의 아키텍처, 보안, 기억 관리, 브라우저 자동화 전략을 심층 비교합니다.
...
├── reports/
│   ├── openclaw_ecosystem_report.md    # 7대 프레임워크 종합 정보
...
| **보안** | S | S | B | B | C | C | D |
| **장기기억** | A | A | S | C | B | B | D |
| **단기기억(세션)** | A | A | A | B | B | B | C |
| **도구 아키텍처** | A | A | S | B | B | B | D |
| **브라우저** | D | A | S | B | - | - | - |
| **MCP 지원** | A | A | A | B | A | A | - |
| **메신저 내장** | - | - | S | A | A | - | A |
| **멀티에이전트** | B | B | B | S | B | - | A |
| **코드 접근성** | D | D | C | A | S | B | B |
| **배포 용이성** | C | B | A | A | A | B | B |
| **커뮤니티/생태계** | B | B | S | B | B | C | C |
