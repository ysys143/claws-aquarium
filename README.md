...
### 2. reports/repos/ecosystem_overview.md (종합)
...
├── reports/
│   ├── repos/                         # repos/ 대상 분석
│   │   ├── *.md                       # 종합 비교 (6): 생태계, 보안, 기억, 세션, 브라우저, 종합
│   │   └── details/                   # 개별 심층 (2): OpenFang, OpenJarvis
...
│   ├── external/                      # 외부 서비스 분석 (중국 빅테크 등)
│   │   ├── *.md                       # 종합 비교 (1): 비교표
│   │   └── details/                   # 개별 심층 (6): Tencent, Xiaomi, Nvidia, 보안
...
|------|------|------------------|---------------------|
| **Claw 프레임워크** | `reports/repos/` | 생태계, 보안, 기억, 세션, 브라우저, 종합 (6) | OpenFang, OpenJarvis (2) |
...
| **외부 서비스** | `reports/external/` | 중국 빅테크 비교표 (1) | Tencent, Xiaomi, Nvidia 등 (6) |
