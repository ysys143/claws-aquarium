...
from recipe.DeepInnovator.utils import is_valid_messages
...
class DeepInnovatorAgentLoop(ToolAgentLoop):
    ...
    async def run(self, sampling_params: dict[str, Any], **kwargs) -> AgentLoopOutput:
        ...
        if self.interaction_config_file:
            ...
            await interaction.start_interaction(request_id, kwargs.get("ground_truth", None), **interaction_kwargs)
        ...
        for _agent_data in interaction_requests:
            ...
            turn_scores_lst.append(_agent_data.turn_scores.copy() if _agent_data.turn_scores else [])
        ...
        output = AgentLoopOutput(
            ...
            extra_fields={
                "turn_scores": sum(turn_scores_lst, []) if turn_scores_lst else [],
